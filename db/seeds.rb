...
Shelter.create(name: "Lizards R US", address: "900 S Cir", city: "Denver", state: "CO", zip: 80205)
...
Shelter.create(name: "Free Animals", address: "101 Pearl St", city: "Denver", state: "CO", zip: 80123)
